...
export default class ProfileStore {
    ...
    @action loadUserProjects =async(username:string,predicate?:string)=>{
        this.loadingActivities=true;
        try{
            const activities= await agent.Profiles.listProjects(username,predicate!);
            runInAction(()=>{
    ...
    @action updateProfile = async (profile: Partial<IProfile>) => {
        ...
        try {
            ...
            toast.error('Problem Update Profile')
            runInAction(() => {
                this.loading = false;
            })
            console.log(error)
